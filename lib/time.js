...
// 'YYYY-MM' in Italy's current wall-clock month — the unit billing.paidThroughMonth
// is tracked in, so a payment made at 23:50 on the last day of the month (still
// today in Rome time, possibly already tomorrow in UTC) credits the right month.
export function romeYearMonth() {
